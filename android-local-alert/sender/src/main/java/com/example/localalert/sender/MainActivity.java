...
public class MainActivity extends Activity {
    ...
    public static final String KEY_LOCK_SCREEN_ENABLED = "lock_screen_enabled";
    ...
    private void saveReceiverIp() {
        ...
        preferences.edit()
                ...
                .putBoolean(KEY_LOCK_SCREEN_ENABLED, true)
                .apply();
        showStatus("تم حفظ العنوان وتفعيل زر شاشة القفل", false);
        Toast.makeText(this, "تم الحفظ. سيظهر الزر بعد ضغط باور", Toast.LENGTH_SHORT).show();
    }
