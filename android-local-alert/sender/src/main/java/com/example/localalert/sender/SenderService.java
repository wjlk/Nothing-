...
public class SenderService extends Service {
    ...
    public static final String ACTION_LOCK_SCREEN_ALERT =
            "com.example.localalert.sender.ACTION_LOCK_SCREEN_ALERT";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        if (intent != null && (ACTION_WIDGET_ALERT.equals(intent.getAction())
                || ACTION_LOCK_SCREEN_ALERT.equals(intent.getAction()))) {
            sendAlertFromWidget();
        }
        return START_STICKY;
    }
